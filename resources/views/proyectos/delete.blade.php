...
@section('content')
<div class="max-w-md mx-auto p-6 bg-white shadow rounded-lg mt-6 text-center border-t-4 border-purple-600">
    ...
    <div class="flex gap-3 justify-center">
        ...
        <button id="btn-eliminar" class="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 disabled:opacity-60 disabled:cursor-not-allowed">
            Eliminar
        </button>
    </div>
</div>
...
document.getElementById('btn-eliminar').addEventListener('click', async (e) => {
    ...
    if (res.status === 204) {
        window.location.href = '/proyectos?eliminado=1';
        return;
    }
