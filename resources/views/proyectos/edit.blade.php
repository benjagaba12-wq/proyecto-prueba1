...
<div class="max-w-lg mx-auto p-6 bg-white shadow rounded-lg mt-6 border-t-4 border-orange-600">
    ...
    <form id="form-editar" class="space-y-4" data-project-id="{{ $proyecto['id'] }}" novalidate>
        <div>
            ...
            <input type="text" name="nombre" maxlength="150" value="{{ $proyecto['nombre'] }}" required
        ...
        <div>
            ...
            <input type="date" name="fecha_inicio" min="2024-01-01" value="{{ $proyecto['fecha_inicio'] }}" required
                   class="mt-1 w-full border-neutral-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500">
        ...
        <div>
            ...
            <input type="text" name="responsable" maxlength="150" value="{{ $proyecto['responsable'] }}" required
                   class="mt-1 w-full border-neutral-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500">
        ...
        <div>
            ...
            <input type="number" step="0.01" min="0" name="monto" value="{{ $proyecto['monto'] }}" required
                   class="mt-1 w-full border-neutral-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500">
